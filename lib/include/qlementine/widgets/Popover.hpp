...
class Popover : public QWidget {
  ...
  Q_PROPERTY(qlementine::Popover::Position preferredPosition READ preferredPosition WRITE setPreferredPosition
      NOTIFY preferredPositionChanged)
  Q_PROPERTY(qlementine::Popover::Alignment preferredAlignment READ preferredAlignment WRITE
